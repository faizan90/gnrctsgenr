...
class GTGAlgLagNthWts:
    ...
    def _set_lag_nth_wts(self, *args):
        ...
        - Call self._init_lag_nth_wts.
        - Set self._alg_wts_lag_nth_search_flag.
        - In a for loop for self._sett_wts_lags_nths_n_iters times:
        ...
        - Unset self._alg_wts_lag_nth_search_flag.
        - Call self._update_lag_nth_wts.
        '''
