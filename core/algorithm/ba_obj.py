...
class GTGAlgObjective:
    ...
    def _get_obj_data_ms_pair_ft_val(self):

        obj_val = (
            (self._rr.data_ms_pair_ft - self._rs.data_ms_pair_ft
             ) ** self._alg_cnsts_diffs_exp).sum()
    ...
    def _get_obj_probs_ms_pair_ft_val(self):

        obj_val = (
            (self._rr.probs_ms_pair_ft - self._rs.probs_ms_pair_ft
             ) ** self._alg_cnsts_diffs_exp).sum()
    ...
    def _get_obj_ftn_val(self):
        ...
        if self._sett_obj_match_data_ms_pair_ft_flag:
            obj_vals.append(self._get_obj_data_ms_pair_ft_val())

        if self._sett_obj_match_probs_ms_pair_ft_flag:
            obj_vals.append(self._get_obj_probs_ms_pair_ft_val())
