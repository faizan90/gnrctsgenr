...
class GTGSettings:
    ...
    '''Specify settings for Simulated Annealing.'''
    ...
    def set_objective_settings(
        ...
        if self._vb:
            ...
            print(
                'Setting objective function settings...\n')
    ...
    def set_objective_weights_settings(
        ...
        weights : 1D float64 np.ndarray or None
            ...
            Must be equal to the number of objective functions available i.e.
        ...
        auto_wts_set_flag : bool
            ...
            parameter set randomization wts_n_iters times, mean of the
    ...
    def set_lags_nths_weights_settings(
        ...
        if self._vb:
            ...
            print(
                'Setting lags\' and nths\' weights settings...\n')
    ...
    def set_label_weights_settings(self, label_exp, label_n_iters):
        ...
        For multivariate simulations, some variables might get lesser
        ...
        is same as that without the weights. The difference happens for the
        behaviour of the objective functions after the application of weights.
        i.e. They may behave more erratic if some labels have much
        higher error than the rest.

        Parameters
        ----------
        label_exp : int or float
            An exponent to scale the weights for each label.
            Higher means more weight for labels that have more error.
            This is done for each variable independently. Should be >= 1
            and < infinity.
        label_n_iters : int
            Number of iterations to estimate the weights. Should be greater
        ...
        if self._vb:
            ...
            print('Setting label weights\' settings...\n')
    ...
    def set_cdf_penalty_settings(self, n_vals_thresh, n_vals_penlt):
        ...
        if self._vb:
            ...
            print('Setting CDF penalties settings...\n')
    ...
    def set_partial_cdf_calibration_settings(
        ...
        if self._vb:
            ...
            print('Setting partial CDF calibration settings...\n')
    ...
    def verify(self):
        ...
        if self._sett_auto_temp_set_flag:
            ...
            if self._vb:
                ...
                print(
                    'Set Annealing initial temperature to None due '
                    'to auto search!')
        ...
        if self._vb:
            ...
            print(f'Settings verified successfully!')
